...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__openframeworks_extra

#else
#  define SWIG_init    init_openframeworks_extra

#endif
#define SWIG_name    "_openframeworks_extra"
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"CallBack__call", _wrap_CallBack__call, METH_VARARGS, NULL},
	 ...
	 { (char *)"_getCallBackPointer", _wrap__getCallBackPointer, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
