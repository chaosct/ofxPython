...
def ofGetNSGLContext():
  return _openframeworks.ofGetNSGLContext()
ofGetNSGLContext = _openframeworks.ofGetNSGLContext

def ofGetCocoaWindow():
  return _openframeworks.ofGetCocoaWindow()
ofGetCocoaWindow = _openframeworks.ofGetCocoaWindow
class ofAppBaseWindow(_object):
    ...
    def getNSGLContext(self): return _openframeworks.ofAppBaseWindow_getNSGLContext(self)
    def getCocoaWindow(self): return _openframeworks.ofAppBaseWindow_getCocoaWindow(self)
