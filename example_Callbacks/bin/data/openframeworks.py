...
class CallBack(_object):
    ...
    __repr__ = _swig_repr
    def _call(self): return _openframeworks.CallBack__call(self)
    ...
    def __init__(self): 
        this = _openframeworks.new_CallBack()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _openframeworks.delete_CallBack
    __del__ = lambda self : None;
CallBack_swigregister = _openframeworks.CallBack_swigregister
CallBack_swigregister(CallBack)


def _getCallBackPointer():
  return _openframeworks._getCallBackPointer()
_getCallBackPointer = _openframeworks._getCallBackPointer
