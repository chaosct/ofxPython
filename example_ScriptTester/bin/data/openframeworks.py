...
def ofSetupOpenGL(w, h, screenMode):
    return _openframeworks.ofSetupOpenGL(w, h, screenMode)
...
def ofScale(xAmnt, yAmnt, zAmnt=1):
    return _openframeworks.ofScale(xAmnt, yAmnt, zAmnt)
...
class ofQuaternion(_object):
    ...
    def __lshift__(self, os):
        return _openframeworks.ofQuaternion___lshift__(self, os)

    def __rshift__(self, arg2):
        return _openframeworks.ofQuaternion___rshift__(self, arg2)
